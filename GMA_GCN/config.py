...
class Config(object):
    def __init__(self, config_file):
        ...
        self.featuregraph_path_1 = conf.get("Data_Setting", "featuregraph_path_1")
        self.featuregraph_path_2 = conf.get("Data_Setting", "featuregraph_path_2")
        self.featuregraph_path_3 = conf.get("Data_Setting", "featuregraph_path_3")
        self.ppmi_path = conf.get("Data_Setting", "ppmi_path")
